...
# Sitemap: http://annasuprunenko.com/sitemap.xml
...
#
# Remember to exchange annasuprunenko.com for your domain (line 64)
...
xml.urlset "xmlns" => "http://www.sitemaps.org/schemas/sitemap/0.9" do
  ...
  sitemap.resources.each do |page|
      ...
      xml.url do
        xml.loc 'http://annasuprunenko.com' + page.url   # TODO: possibly remove .html
